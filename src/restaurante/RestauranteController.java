...
public class RestauranteController {
	...
	/**
	 * Responsavel por cadastrar uma Refeicao no cardapio. Uma refeicao representa um conjunto de pratos.
	 * 
	 ...
	 * 
	 * @param nome Nome de uma Refeicao ou de um Prato.
	 * @param atributo Consulta o preco, ou a descricao, de um Prato ou Refeicao.
	 * @return Retorna uma String, que pode ser a Descricao ou o Preco no formato: "R$00,00"
	 * @throws RestauranteInvalidoException
	 */
